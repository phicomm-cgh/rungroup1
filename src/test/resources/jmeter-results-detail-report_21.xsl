...
<xsl:param    name="showData" select="'n'"/>  <!-- 此处已经修改成YES -->
	...
	<html>
		<head>
			...
			<style type="text/css">
				...
				table { table-layout: fixed <!-- 设置固定宽度 --> }
				table tr th, table tr td { font-size: 68% }
				table tr th, table tr td { white-space: pre-line; word-break: break-all }
